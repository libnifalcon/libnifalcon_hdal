 ...
 * @version $Id: FalconNovintHDALCompat.cpp 199 2008-10-11 05:00:32Z kmachulis $
 * @copyright (c) 2007-2008 Nonpolynomial Labs/Kyle Machulis
 * @license BSD License
 *
 * $HeadURL: https://kmachulis@libnifalcon.svn.sourceforge.net/svnroot/libnifalcon/trunk/libnifalcon_hdal/src/FalconNovintHDALCompat.cpp $
 * 
